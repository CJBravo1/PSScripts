...
{
    $SharedMailboxes = Get-Mailbox -ResultSize Unlimited | Where-Object {$_.RecipientTypeDetails -eq "UserMailbox"}
    $SharedMailboxes | ForEach-Object {
        ...
        $members | Select-Object Identity,User,AccessRights | export-csv  -NoTypeInformation .\UserMailboxMemberExport.csv -Append
        }
}
