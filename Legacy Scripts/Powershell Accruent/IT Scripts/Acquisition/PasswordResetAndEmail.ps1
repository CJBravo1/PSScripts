...
foreach($User in $Users)
{
	...
	$username
	$AccquriedEmail = $User.CurrentEmail
	...
	$subject = "DELIVERY | Accruent User Credentials for $AccquiredCompany Employees"
    $body = 
...
<br>
<b><span style=`"color:red;`">IMPORTANT!!!</span></b> &#8212 Please make sure you complete the login and password change process (Step 2, below) by Monday, 4/23. This will make sure your credentials are all configured by the start of the email migrations. <br>
<br>
<b><u>ACTION</u></b><br>
<ol>
	<li>First, open the attached Word document that explains how to log into your Accruent Office 365 account, set up your Multi-Factor Authentication, and then log into your Confluence account.</li>
	<li>Once you have logged into your Office 365 account, and then logged into your Confluence account, go <a href=https://accruent.atlassian.net/wiki/spaces/IT/pages/375161165/O365+Changing+your+password>here</a> to find out how to reset your password on your Office 365 account.</li>
    <li>After you have accessed Confluence, go <a href=https://accruent.atlassian.net/wiki/spaces/IT/pages/403702123/O365+Download+Office+Suite>here</a> to find out how to download and install the Office 365 suite. You can absolutely use all of the Office suite through the web versions just like you did with the G-Suite, but the apps have a bit more functionality than the web versions.</li>
    <li>Another item to download will be Microsoft Teams. You can go <a href=https://accruent.atlassian.net/wiki/spaces/IT/pages/364871750/TEAMS+How+to+download+the+Microsoft+Teams+desktop+client.>here</a> to find out how to download MS Teams, which is their version or Hangouts, and where all of your Accruent counterparts will be available to chat and collaborate with.</li>
...
<i>Tech Tips:</i> <ul>
	...
	<li><i><b>Best Practices:</b></i> Bookmark <a href=https://accruent.atlassian.net/wiki/spaces/CAI/pages/562694217/Welcome+BlueCielo+Team>$AccquiredCompany Integration page.</a></li>
...
Please go <a href=https://accruent.atlassian.net/wiki/spaces/CAI/pages/600539616/Welcome+Connectiv+Team>here</a> to find all the information contained within this email for future reference.<br>
<br>
Thank you,<br>
<br>
Josh Batson <br>
...
C 512-771-3087<br>
"
	$bcc = "jbatson@accruent.com","regan.a.vecera@accruent.com","elco.de.jong@accruent.com"
	Write-Host "Sending mail message to $email" -ForegroundColor Red
	Send-MailMessage -To $email -bcc $bcc -Subject $subject -Body $body -SmtpServer $mxserver -From "jbatson@accruent.com" -UseSsl -BodyAsHtml -Credential $UserCredential -Attachments $attachedfile
