...
mkdir C:\Temp
.\Get-WindowsAutoPilotInfo.ps1 -Output C:\Temp\AutoPilot.csv

$computers | Select "Device Serial Number", "Windows Product ID", "Hardware Hash" | Export-Csv C:\Temp\AutoPilot2.csv