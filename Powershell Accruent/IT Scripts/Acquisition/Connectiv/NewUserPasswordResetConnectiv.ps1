...
foreach($User in $Users)
{
	...
	$subject = "DELIVERY | Accruent User Credentials for Connectiv Employees"
    $body = 
...
<i>Tech Tips:</i> <ul>
	...
	<li><i><b>Best Practices:</b></i> Bookmark <a href=https://accruent.atlassian.net/wiki/spaces/CAI/pages/600539616/Welcome+Connectiv+Team>Connectiv Integration page.</a></li>
